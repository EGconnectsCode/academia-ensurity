...
(function () {
  ...
  (function injectDesign() {
    ...
    style.textContent = `
      ...
      body.dark button:not([class*="az-"]):not(.sb-item):not(.dt2-tab):not(.fs-tab):not(.et-tab):not(.ft-tab) {
        background:#1E293B!important; color:#E2E8F0!important; border-color:rgba(255,255,255,.12)!important;
      }
      body.dark button:not([class*="az-"]):not(.sb-item):not(.dt2-tab):not(.fs-tab):not(.et-tab):not(.ft-tab):hover { background:#2D3B55!important; }
      ...
      /* Replace hardcoded hero stats with dynamic ones */
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      if (hero && !hero.querySelector('.az-hero-stats')) {
        ...
        statsWrap.innerHTML =
          '<div class="az-h-stat"><div class="az-h-stat-n" id="az-lb-dls">0</div><div class="az-h-stat-l">Docs</div></div>' +
          '<div class="az-h-stat"><div class="az-h-stat-n" id="az-lb-xp">0</div><div class="az-h-stat-l">XP</div></div>';
        hero.appendChild(statsWrap);
      }

      // Remove emojis from sidebar items and headings
  ...
  window.doForgot = async function () {
    ...
    } catch (e) { console.error('[LB Patch] Forgot error:', e.message); }
  };
  ...
  window.qzFinish = window.azFinishQuiz = async function (mid, score, xpEarned) {
    ...
    } catch (e) { console.warn('[LB Patch] qzFinish error:', e.message); }
  };
